...
(*
  Questions:
  - NoPermutations vs NoPermutations' vs NoPermutations'' ?
  - Qed vs Defined in NoPermutations.
  - Define both DFSChainTrace and DFSChainStep ?
*)
...
(*   Lemma q {from to : ChainState} : forall t1 t2,
    @DFSChainTrace_to_ChainTrace from to t1 = @DFSChainTrace_to_ChainTrace from to t2 ->
      t1 = t2.
  Proof.
  Admitted. *)
